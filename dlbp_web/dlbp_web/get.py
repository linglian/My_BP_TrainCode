...
def uploadImg(request):
    ...
    if request.method == 'POST':
        ...
        file_name = u'/home/lee/DeepLearn/My_BP_TrainCode/dlbp_web/static/image/temp_{}.jpg'.format(f_name)
        ...
        for i in result_list:
            ...
            for j in range(idx - 2):
                str1 = str1 + '_' + file_name.split('/')[-1].split('_')[j + 1]

            str1 = str1 + '_000' + file_name.split('/')[-1].split('_')[idx - 1][3:]

            i[1] = str1
            i[2] = '%.2f%% %s' % (i[2], file_name.split('/')[-1][0:-8])
